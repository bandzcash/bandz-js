...
export const defaultConfig: TxBuilderConfig = {
  governance: {
    ...
    kovan: {
      BANDZ_GOVERNANCE_V2: '0xc2eBaB3Bac8f2f5028f5C7317027A41EBFCa31D2',
      BANDZ_GOVERNANCE_V2_EXECUTOR_SHORT:
        '0x462eD5dc919BE6C96639D5f31ab919EBA8F31831',
      BANDZ_GOVERNANCE_V2_EXECUTOR_LONG:
        '0x7e5195b0A6a60b371Ba3276032CF6958eADFA652',
      BANDZ_GOVERNANCE_V2_HELPER: '0xffd5BEb5712952FC9a9DDC7499487422B29Fdda6',
    },
  },
  lendingPool: {
    mainnet: {
    ...
    kovan: {
      proto: {
        ...
        WBCH_GATEWAY: '0xA61ca04DF33B72b235a8A28CfB535bb7A5271B70',
    ...
    polygon: {
      proto: {
        ...
        WBCH_GATEWAY: '0xbEadf48d62aCC944a06EEaE0A9054A90E5A7dc97',
    ...
    mumbai: {
      proto: {
        ...
        WBCH_GATEWAY: '0xee9eE614Ad26963bEc1Bec0D2c92879ae1F209fA',
